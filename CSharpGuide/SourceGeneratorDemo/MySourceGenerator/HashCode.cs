...
{
    // https://source.dot.net/#System.Private.CoreLib/src/libraries/System.Private.CoreLib/src/System/HashCode.cs,5f9e3dc86db22de1
    internal struct HashCode
    {
        ...
        {
            return RotateLeft(v1, offset: 1) + RotateLeft(v2, 7) + RotateLeft(v3, 12) + RotateLeft(v4, 18);
        }
